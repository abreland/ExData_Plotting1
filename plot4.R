...
plot(range(d2$dateTime),range(d2$Voltage ), type="n", ylab="Voltage", xlab="datetime")
...
plot(range(d2$dateTime),range(d2$Global_reactive_power), type="n",  ylab="Global_reactive_power",  xlab="datetime")
